...
plot_gmm(X);
saveas(figure(1),'test_gmm_fig1.jpg','jpg')
...
plot_gmm(X,mu,z,BIC);
saveas(figure(2),'test_gmm_fig2.jpg','jpg')
mypause;
...
saveas(figure(3),'test_gmm_fig3.jpg','jpg')
mypause;
...
plot(allK,allS,'bx-');
xlabel('K'); ylabel('BIC');
saveas(figure(4),'test_gmm_fig4.jpg','jpg')
...
mypause;
saveas(figure(5),'test_gmm_fig5.jpg','jpg')